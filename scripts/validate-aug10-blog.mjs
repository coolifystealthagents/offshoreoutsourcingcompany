...
if (accepted.length < 22) throw new Error(`accepted count ${accepted.length} is below minimum`);
...
if (!index.includes("sort((a,b)=>(b as {publishedAt?: string}).publishedAt?.localeCompare")) throw new Error('index sort missing');
